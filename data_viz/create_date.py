...
hover_data=['summary', 'investigative_findings'])

total_rows = 2792 #individual reports not number of reports against individual officers
no_cap_investigation = 180 #allegations investigated
sustained_finding = 1354 #Sustained Finding from investigative findings
black_complainants = 4725
actual_action = 822 #Guilting Finding or Training/Counseling
...
def update_graph(race, sex, type_opt):
    ...
    if df_temp['general_cap_classification'].count() <= 1:
        ...
        hover_data=['summary', 'investigative_findings', 'disciplinary_findings'])
